...
function renderDrawerComments() {
  ...
  const items = [
    { u: 'خالد',   c: '#00e5a0', t: 'منذ ساعة',    likes: 47,  text: 'نظرية: دانة هي نسل الملك الأول. كل الإشارات موجودة من الفصل 10! 🤯' },
    { u: 'أم.ق',   c: '#FFD100', t: 'منذ 3 ساعات', likes: 142, text: 'الفصل الأخير كسر قلبي! ما توقعت إن سالم يعرف الحقيقة بهالطريقة 🔥' },
    ...
    { u: 'م.ع',    c: '#38bdf8', t: 'منذ 3 أيام',   likes: 21,  text: 'الرسم في هذا الفصل من الله. كيف ينقل ماجد الحجم والمسافة بهالطريقة؟' },
  ];
